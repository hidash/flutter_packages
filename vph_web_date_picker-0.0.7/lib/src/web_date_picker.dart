...
class _WebDatePicker extends StatefulWidget {
  const _WebDatePicker({
    ...
    this.primaryColor=const Color(0xFF2A86AC),
    ...
    for (int i = 0; i < kNumberCellsOfMonth; i++) {
      ...
      if (_startDate.month == date.month) {
        ...
        final color = isEnabled
            ? (primaryColor??Color(0xFF2A86AC) )//theme.colorScheme.primaryColor
            :(primaryColor ??Color(0xFF2A86AC)).withOpacity(0.5);
            ...
            Row(
              children: [
                ...
                TextButton(
                  ...
                  child: Text(localizations.cancelButtonLabel,style: TextStyle(
                      color: primaryColor)),
                ),
